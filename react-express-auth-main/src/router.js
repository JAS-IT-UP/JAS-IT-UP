...
Router.get("/saved_posts", savedPostController.findUsersSavedPost);
...
Router.get("/saved_posts/post/:id", savedPostController.findUsersSavedPost);
...
Router.post(
  "/posts",
  checkAuthentication,
  require("./controllers/post").create
);
Router.get("/posts/:id", require("./controllers/post").find);
Router.get(
  "/user_posts/:id",
  checkAuthentication,
  require("./controllers/post").findUserPost
);
Router.delete(
  "/posts/:id",
  checkAuthentication,
  require("./controllers/post").deletePost
);
Router.delete(
  "/saved_posts/:id",
  require("./controllers/saved_posts").deleteSavedPost
);
Router.patch(
  "/users/:id",
  checkAuthentication,
